		...
		if ((((new Object() {
			...
			if (entity instanceof PlayerEntity && !entity.world.isRemote()) {
				((PlayerEntity) entity).sendStatusMessage(new StringTextComponent((("\u00A76===== \u00A7c\u00A7lErinaLvl Help \u00A7r\u00A76=====")
						+ "" + ("\u00A7a\u00A7lListe des commandes:") + "" + ("\u00A73- /erinalvl help \u00A7c(pour avoir la liste des commandes)")
						+ "" + ("\u00A73- /erinalvl givexp \u00A7c(pour se give de l'xp)") + ""
						+ ("\u00A73- /erinalvl givelvl \u00A7c(pour se give du niveaux)") + ""
						+ ("\u00A73 - /erinalvl setlvl \u00A7c(pour se mettre a un niveaux pr\u00E9cis)"))), (false));
			}
		} else if ((((new Object() {
			public String getText() {
				String param = (String) cmdparams.get("0");

...
public class ReturnworldCommandExecutedProcedure extends ErinafactionModElements.ModElement {
	public ReturnworldCommandExecutedProcedure(ErinafactionModElements instance) {
		super(instance, 80);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				ErinafactionMod.LOGGER.warn("Failed to load dependency entity for procedure ReturnworldCommandExecuted!");
			return;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				ErinafactionMod.LOGGER.warn("Failed to load dependency world for procedure ReturnworldCommandExecuted!");
			return;
		}

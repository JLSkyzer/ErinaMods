...
public class BloodesiumDirtBlock extends ErinafactionModElements.ModElement {
	@ObjectHolder("erinafaction:bloodesium_dirt")
	public static final Block block = null;
	public BloodesiumDirtBlock(ErinafactionModElements instance) {
		super(instance, 17);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("bloodesium_dirt");
		}

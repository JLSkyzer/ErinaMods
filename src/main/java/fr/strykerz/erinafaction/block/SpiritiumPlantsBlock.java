...
public class SpiritiumPlantsBlock extends ErinafactionModElements.ModElement {
	@ObjectHolder("erinafaction:spiritium_plants")
	public static final Block block = null;
	public SpiritiumPlantsBlock(ErinafactionModElements instance) {
		super(instance, 73);
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("spiritium_plants");
		}

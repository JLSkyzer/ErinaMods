...
public class BloodesiumFlowerBlock extends ErinafactionModElements.ModElement {
	@ObjectHolder("erinafaction:bloodesium_flower")
	public static final Block block = null;
	public BloodesiumFlowerBlock(ErinafactionModElements instance) {
		super(instance, 22);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("bloodesium_flower"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("erinafaction:bloodesium_flower"), configuredFeature);
		}
	}
	@SubscribeEvent
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("bloodesium_flower");
		}

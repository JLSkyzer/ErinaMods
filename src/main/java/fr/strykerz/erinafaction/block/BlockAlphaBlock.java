...
public class BlockAlphaBlock extends ErinafactionModElements.ModElement {
	@ObjectHolder("erinafaction:block_alpha")
	public static final Block block = null;
	public BlockAlphaBlock(ErinafactionModElements instance) {
		super(instance, 61);
	}

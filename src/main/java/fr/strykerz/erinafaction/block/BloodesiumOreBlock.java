...
public class BloodesiumOreBlock extends ErinafactionModElements.ModElement {
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("bloodesium_ore");
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("erinafaction:bloodesium_ore_match"),
			...
			configuredFeature = feature.withConfiguration(new OreFeatureConfig(CustomRuleTest.INSTANCE, block.getDefaultState(), 7)).range(14)
					.square().func_242731_b(12);
			event.getRegistry().register(feature.setRegistryName("bloodesium_ore"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("erinafaction:bloodesium_ore"), configuredFeature);
		}
	}
	@SubscribeEvent

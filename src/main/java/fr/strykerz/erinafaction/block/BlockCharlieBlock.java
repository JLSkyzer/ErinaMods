...
public class BlockCharlieBlock extends ErinafactionModElements.ModElement {
	@ObjectHolder("erinafaction:block_charlie")
	public static final Block block = null;
	public BlockCharlieBlock(ErinafactionModElements instance) {
		super(instance, 63);
	}

...
public class SpiritiumCobblestoneBlock extends ErinafactionModElements.ModElement {
	@ObjectHolder("erinafaction:spiritium_cobblestone")
	public static final Block block = null;
	public SpiritiumCobblestoneBlock(ErinafactionModElements instance) {
		super(instance, 74);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("spiritium_cobblestone");
		}

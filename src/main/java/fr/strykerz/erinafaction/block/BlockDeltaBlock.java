...
public class BlockDeltaBlock extends ErinafactionModElements.ModElement {
	@ObjectHolder("erinafaction:block_delta")
	public static final Block block = null;
	public BlockDeltaBlock(ErinafactionModElements instance) {
		super(instance, 64);
	}

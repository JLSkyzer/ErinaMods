...
public class BlockBetaBlock extends ErinafactionModElements.ModElement {
	@ObjectHolder("erinafaction:block_beta")
	public static final Block block = null;
	public BlockBetaBlock(ErinafactionModElements instance) {
		super(instance, 62);
	}

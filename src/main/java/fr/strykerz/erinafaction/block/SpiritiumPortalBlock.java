...
import fr.strykerz.erinafaction.procedures.SpiritiumPortalOnBlockRightClickedProcedure;
...
public class SpiritiumPortalBlock extends ErinafactionModElements.ModElement {
	@ObjectHolder("erinafaction:spiritium_portal")
	public static final Block block = null;
	public SpiritiumPortalBlock(ErinafactionModElements instance) {
		super(instance, 78);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("spiritium_portal");
		}
		...
		public ActionResultType onBlockActivated(BlockState state, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			Direction direction = hit.getFace();
			{
				...
				SpiritiumPortalOnBlockRightClickedProcedure.executeProcedure($_dependencies);
			}

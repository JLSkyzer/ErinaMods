...
public class SpiritiumGrassBlock extends ErinafactionModElements.ModElement {
	@ObjectHolder("erinafaction:spiritium_grass")
	public static final Block block = null;
	public SpiritiumGrassBlock(ErinafactionModElements instance) {
		super(instance, 72);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("spiritium_grass");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(SpiritiumDirtBlock.block, (int) (1)));
		}
	}
}

...
public class SpiritiumDirtBlock extends ErinafactionModElements.ModElement {
	@ObjectHolder("erinafaction:spiritium_dirt")
	public static final Block block = null;
	public SpiritiumDirtBlock(ErinafactionModElements instance) {
		super(instance, 70);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("spiritium_dirt");
		}

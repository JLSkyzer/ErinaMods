...
import fr.strykerz.erinafaction.block.BloodesiumWoodBlock;
import fr.strykerz.erinafaction.block.BloodesiumLeavesBlock;
import fr.strykerz.erinafaction.block.BloodesiumGrassBlock;
import fr.strykerz.erinafaction.block.BloodesiumDirtBlock;
import fr.strykerz.erinafaction.ErinafactionModElements;

import com.google.common.collect.ImmutableList;

@ErinafactionModElements.ModElement.Tag
public class BloodesiumBiomeBiome extends ErinafactionModElements.ModElement {
	public static Biome biome;
	public BloodesiumBiomeBiome(ErinafactionModElements instance) {
		super(instance, 53);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(-10354688).setWaterColor(-9747902).setWaterFogColor(-6080199)
						.withSkyColor(-10354688).withFoliageColor(-12643308).withGrassColor(-12643308).build();
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder().withSurfaceBuilder(
						SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(BloodesiumGrassBlock.block.getDefaultState(),
								BloodesiumDirtBlock.block.getDefaultState(), BloodesiumDirtBlock.block.getDefaultState())));
				...
				biomeGenerationSettings.withFeature(GenerationStage.Decoration.VEGETAL_DECORATION,
						Feature.TREE
								.withConfiguration(
										(new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(BloodesiumWoodBlock.block.getDefaultState()),
												new SimpleBlockStateProvider(BloodesiumLeavesBlock.block.getDefaultState()),
				...
				biome = new Biome.Builder().precipitation(Biome.RainType.RAIN).category(Biome.Category.PLAINS).depth(0.2f).scale(0.6f).temperature(1f)
						.downfall(0.5f).setEffects(effects).withMobSpawnSettings(mobSpawnInfo.copy())
						.withGenerationSettings(biomeGenerationSettings.build()).build();
				event.getRegistry().register(biome.setRegistryName("erinafaction:bloodesium_biome"));
			}
		}
	}
	@Override
	public void init(FMLCommonSetupEvent event) {
		BiomeDictionary.addTypes(RegistryKey.getOrCreateKey(Registry.BIOME_KEY, WorldGenRegistries.BIOME.getKey(biome)), BiomeDictionary.Type.PLAINS,
				BiomeDictionary.Type.FOREST, BiomeDictionary.Type.MOUNTAIN, BiomeDictionary.Type.MESA, BiomeDictionary.Type.COLD,
	...
	private static class CustomLeaveVineTreeDecorator extends LeaveVineTreeDecorator {
		...
		static {
			...
			tdt.setRegistryName("bloodesium_biome_lvtd");
	...
	private static class CustomTrunkVineTreeDecorator extends TrunkVineTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("bloodesium_biome_tvtd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
		@Override
		protected TreeDecoratorType<?> func_230380_a_() {
	...
	private static class CustomCocoaTreeDecorator extends CocoaTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("bloodesium_biome_ctd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}

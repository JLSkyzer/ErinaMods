package fr.strykerz.erinafaction;
...
public class ErinafactionModVariables {
	public ErinafactionModVariables(ErinafactionModElements elements) {
	...
	public void onAttachCapabilities(AttachCapabilitiesEvent<Entity> event) {
		if (event.getObject() instanceof PlayerEntity && !(event.getObject() instanceof FakePlayer))
			event.addCapability(new ResourceLocation("erinafaction", "player_variables"), new PlayerVariablesProvider());
	}
